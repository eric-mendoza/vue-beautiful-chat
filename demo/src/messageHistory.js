export default [
  [
    ...
    { type: 'file', author: `me`, id: 15, data: { text: `What about this one instead?? `, file: { url: 'http://www.quickmeme.com/img/2d/2d95cc80f9a2a2578a8f632eebecddcc1c12e5b08ab85f81a5d401670d5f36c1.jpg' }, meta: '✓✓ ' }, timestamp: (new Date()).getHours() + ':' + (new Date()).getMinutes()},
    ...
    { type: 'text', author: `me`, id: 18, data: { text: `Do you read me...`, meta: '✓✓ ' } },
    { type: 'text', author: `me`, id: 19, data: { text: `...or not?`, meta: '✓ ' }, timestamp: (new Date()).getHours() + ':' + (new Date()).getMinutes() },
  ...
  [
    { type: 'text', author: `me`, id: 0, data: { text: `Why don't they have salsa on the table?` } },
    { type: 'text', author: `ericmendoza`, id: 1, data: { text: `What do you need salsa for?` } },
    { type: 'text', author: `me`, id: 2, data: { text: `Salsa is now the number one condiment in America. Guatemalan salsa is better` } },
    { type: 'text', author: `ericmendoza`, id: 3, data: { text: `Second Chat! You know why? Because people like to say 'salsa.' 'Excuse me, do you have salsa?' 'We need more salsa.' 'Where is the salsa? No salsa?'` } },
    { type: 'text', author: `me`, id: 4, data: { text: `You know it must be impossible for a Spanish person to order seltzer and not get salsa. 'I wanted seltzer, not salsa.' 2` } },
    { type: 'text', author: `ericmendoza`, id: 5, data: { text: `Don't you know the difference between seltzer and salsa?? You have the seltezer after the salsa! 2` } },
    { type: 'text', author: `me`, id: 6, data: { text: `See, this should be a show. This is the show. 2` } },
    { type: 'text', author: `ericmendoza`, id: 7, data: { text: `What? 2` } },
    { type: 'text', author: `me`, id: 8, data: { text: `This. Just talking 2.` } },
    { type: 'text', author: `ericmendoza`, id: 9, data: { text: `Yeah, right message 2.` } },
  ],
  [
    { type: 'system', id: 13, data: { text: 'You have been transferred to another operator', meta: '04-07-2018 15:57' } },
    { type: 'text', author: `support`, id: 16, data: { text: `You've got to have a story. You've got to have a story. You've got to have a story. You've got to have a story. You've got to have a story. You've got to have a story. ` } },
